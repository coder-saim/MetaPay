"""
Django settings for metapay project.
...
SECRET_KEY = 'django-insecure-ad&7du%)xfhpcw80e+!-w&g@c^1ui_#wu7y_bji8+b+d26cs_5'
...
WSGI_APPLICATION = 'metapay.wsgi.application'
